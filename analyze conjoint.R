...
df = data.table::fread('C:/Users/hannesrosenbusch/Documents/introducing conjoint/adminexport400.csv', data.table = F)
df = df[,grepl('Welche dieser', colnames(df))] #select relevant columns
key = data.table::fread('C:/Users/hannesrosenbusch/Documents/introducing conjoint/choice sets-2021-06-18.csv', data.table = F)
nr_profiles = 3
none_option = FALSE
